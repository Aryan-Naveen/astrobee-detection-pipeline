...
(cl:defclass <Detection3DArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector object_pose_estimation-msg:Detection3D)
   :initform (cl:make-array 0 :element-type 'object_pose_estimation-msg:Detection3D :initial-element (cl:make-instance 'object_pose_estimation-msg:Detection3D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Detection3DArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Detection3DArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_pose_estimation-msg:<Detection3DArray> is deprecated: use object_pose_estimation-msg:Detection3DArray instead.")))
...
(cl:defmethod detections-val ((m <Detection3DArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_pose_estimation-msg:detections-val is deprecated.  Use object_pose_estimation-msg:detections instead.")
  (detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Detection3DArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'object_pose_estimation-msg:Detection3D))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Detection3DArray>)))
  ...
  "object_pose_estimation/Detection3DArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Detection3DArray)))
  "Returns string type for a message object of type 'Detection3DArray"
  "object_pose_estimation/Detection3DArray")
