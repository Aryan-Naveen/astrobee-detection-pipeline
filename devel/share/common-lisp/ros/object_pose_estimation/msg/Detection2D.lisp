...
(cl:defclass <Detection2D> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bbox
    :reader bbox
    :initarg :bbox
    :type object_pose_estimation-msg:BoundingBox2D
    :initform (cl:make-instance 'object_pose_estimation-msg:BoundingBox2D))
   (source_img
    :reader source_img
    :initarg :source_img
...
(cl:defmethod cl:initialize-instance :after ((m <Detection2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Detection2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_pose_estimation-msg:<Detection2D> is deprecated: use object_pose_estimation-msg:Detection2D instead.")))
...
(cl:defmethod source_img-val ((m <Detection2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_pose_estimation-msg:source_img-val is deprecated.  Use object_pose_estimation-msg:source_img instead.")
  (source_img m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Detection2D>)))
  ...
  "object_pose_estimation/Detection2D")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Detection2D)))
  "Returns string type for a message object of type 'Detection2D"
  "object_pose_estimation/Detection2D")
