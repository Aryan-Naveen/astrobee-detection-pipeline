...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox3D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox3D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_pose_estimation-msg:<BoundingBox3D> is deprecated: use object_pose_estimation-msg:BoundingBox3D instead.")))
...
(cl:defmethod size-val ((m <BoundingBox3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_pose_estimation-msg:size-val is deprecated.  Use object_pose_estimation-msg:size instead.")
  (size m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BoundingBox3D>)))
  ...
  "object_pose_estimation/BoundingBox3D")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BoundingBox3D)))
  "Returns string type for a message object of type 'BoundingBox3D"
  "object_pose_estimation/BoundingBox3D")
