...
(cl:defclass <Detection3D> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (results
    :reader results
    :initarg :results
    :type (cl:vector object_pose_estimation-msg:ObjectHypothesisWithPose)
   :initform (cl:make-array 0 :element-type 'object_pose_estimation-msg:ObjectHypothesisWithPose :initial-element (cl:make-instance 'object_pose_estimation-msg:ObjectHypothesisWithPose)))
   (bbox
    :reader bbox
    :initarg :bbox
    :type object_pose_estimation-msg:BoundingBox3D
    :initform (cl:make-instance 'object_pose_estimation-msg:BoundingBox3D))
   (source_cloud
    :reader source_cloud
...
(cl:defmethod cl:initialize-instance :after ((m <Detection3D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Detection3D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_pose_estimation-msg:<Detection3D> is deprecated: use object_pose_estimation-msg:Detection3D instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Detection3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_pose_estimation-msg:header-val is deprecated.  Use object_pose_estimation-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'results-val :lambda-list '(m))
(cl:defmethod results-val ((m <Detection3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_pose_estimation-msg:results-val is deprecated.  Use object_pose_estimation-msg:results instead.")
  (results m))

(cl:ensure-generic-function 'bbox-val :lambda-list '(m))
(cl:defmethod bbox-val ((m <Detection3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_pose_estimation-msg:bbox-val is deprecated.  Use object_pose_estimation-msg:bbox instead.")
  (bbox m))

(cl:ensure-generic-function 'source_cloud-val :lambda-list '(m))
(cl:defmethod source_cloud-val ((m <Detection3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_pose_estimation-msg:source_cloud-val is deprecated.  Use object_pose_estimation-msg:source_cloud instead.")
  (source_cloud m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Detection3D>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'results)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'object_pose_estimation-msg:ObjectHypothesisWithPose))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Detection3D>)))
  ...
  "object_pose_estimation/Detection3D")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Detection3D)))
  "Returns string type for a message object of type 'Detection3D"
  "object_pose_estimation/Detection3D")
