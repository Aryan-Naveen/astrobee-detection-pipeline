...
(cl:defclass <Classification3D> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (results
    :reader results
    :initarg :results
    :type (cl:vector object_pose_estimation-msg:ObjectHypothesis)
   :initform (cl:make-array 0 :element-type 'object_pose_estimation-msg:ObjectHypothesis :initial-element (cl:make-instance 'object_pose_estimation-msg:ObjectHypothesis)))
   (source_cloud
    :reader source_cloud
...
(cl:defmethod cl:initialize-instance :after ((m <Classification3D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Classification3D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_pose_estimation-msg:<Classification3D> is deprecated: use object_pose_estimation-msg:Classification3D instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Classification3D>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'results)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'object_pose_estimation-msg:ObjectHypothesis))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Classification3D>)))
  ...
  "object_pose_estimation/Classification3D")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Classification3D)))
  "Returns string type for a message object of type 'Classification3D"
  "object_pose_estimation/Classification3D")
