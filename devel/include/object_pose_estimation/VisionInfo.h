// Generated by gencpp from file object_pose_estimation/VisionInfo.msg
// DO NOT EDIT!


#ifndef OBJECT_POSE_ESTIMATION_MESSAGE_VISIONINFO_H
#define OBJECT_POSE_ESTIMATION_MESSAGE_VISIONINFO_H
...
struct VisionInfo_
{
  ...
  typedef boost::shared_ptr< ::object_pose_estimation::VisionInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::object_pose_estimation::VisionInfo_<ContainerAllocator> const> ConstPtr;

}; // struct VisionInfo_

typedef ::object_pose_estimation::VisionInfo_<std::allocator<void> > VisionInfo;

typedef boost::shared_ptr< ::object_pose_estimation::VisionInfo > VisionInfoPtr;
typedef boost::shared_ptr< ::object_pose_estimation::VisionInfo const> VisionInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::object_pose_estimation::VisionInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::object_pose_estimation::VisionInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct HasHeader< ::object_pose_estimation::VisionInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::object_pose_estimation::VisionInfo_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::object_pose_estimation::VisionInfo_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::object_pose_estimation::VisionInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::object_pose_estimation::VisionInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::object_pose_estimation::VisionInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::object_pose_estimation::VisionInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::object_pose_estimation::VisionInfo_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OBJECT_POSE_ESTIMATION_MESSAGE_VISIONINFO_H
