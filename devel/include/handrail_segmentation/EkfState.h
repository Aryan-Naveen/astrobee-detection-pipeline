// Generated by gencpp from file handrail_segmentation/EkfState.msg
// DO NOT EDIT!


#ifndef HANDRAIL_SEGMENTATION_MESSAGE_EKFSTATE_H
#define HANDRAIL_SEGMENTATION_MESSAGE_EKFSTATE_H
...
namespace handrail_segmentation
{
...
// reducing the odds to have name collisions with Windows.h 
...
#endif
#if defined(_WIN32) && defined(CONFIDENCE_LOST)
  #undef CONFIDENCE_LOST
#endif
  ...
  typedef boost::shared_ptr< ::handrail_segmentation::EkfState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::handrail_segmentation::EkfState_<ContainerAllocator> const> ConstPtr;

}; // struct EkfState_

typedef ::handrail_segmentation::EkfState_<std::allocator<void> > EkfState;

typedef boost::shared_ptr< ::handrail_segmentation::EkfState > EkfStatePtr;
typedef boost::shared_ptr< ::handrail_segmentation::EkfState const> EkfStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::handrail_segmentation::EkfState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::handrail_segmentation::EkfState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::handrail_segmentation::EkfState_<ContainerAllocator1> & lhs, const ::handrail_segmentation::EkfState_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.cov_diag == rhs.cov_diag &&
    lhs.confidence == rhs.confidence &&
    lhs.aug_state_enum == rhs.aug_state_enum &&
    lhs.status == rhs.status &&
    lhs.of_count == rhs.of_count &&
    lhs.ml_count == rhs.ml_count &&
    lhs.hr_global_pose == rhs.hr_global_pose &&
    lhs.ml_mahal_dists == rhs.ml_mahal_dists &&
    lhs.estimating_bias == rhs.estimating_bias;
}
...
template <class ContainerAllocator>
struct IsMessage< ::handrail_segmentation::EkfState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::handrail_segmentation::EkfState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::handrail_segmentation::EkfState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::handrail_segmentation::EkfState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::handrail_segmentation::EkfState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::handrail_segmentation::EkfState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::handrail_segmentation::EkfState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::handrail_segmentation::EkfState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x543b97822b033d71ULL;
  static const uint64_t static_value2 = 0x99b506ad4005f134ULL;
};

template<class ContainerAllocator>
struct DataType< ::handrail_segmentation::EkfState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::handrail_segmentation::EkfState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::handrail_segmentation::EkfState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::handrail_segmentation::EkfState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::handrail_segmentation::EkfState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // HANDRAIL_SEGMENTATION_MESSAGE_EKFSTATE_H
